...
export function fetchPageUseCompList(opts) {
  if (isPrivateDeployment) {
    const url = getStaticUrl('DP_STATIC_PAGECOMP', opts.pageId);
    return loadScript(url, 'DP_STATIC_PAGECOMP');
  }
...
export function fetchPageConfig(opts) {
  if (isPrivateDeployment) {
    const url = getStaticUrl('DP_STATIC_PAGE', opts.pageId);
    return loadScript(url, 'DP_STATIC_PAGE');
  }
...
// default
export function updateTagPageDefault(opts) {
  return API.patch(`/page/default`, opts);
}
...
// 组件批量新增
export function copyBatchAddComp(opts) {
  return API.post(`/page-comp/copyBatchAdd`, opts);
}
...
export function getAllDataSource(opts) {
  if (isPrivateDeployment) {
    const url = getStaticUrl('DP_STATIC_DATASOURCE', opts.pageId);
    return loadScript(url, 'DP_STATIC_DATASOURCE');
  }
...
// 禁用启用用户
export function disabledMember(params) {
  return API.patch(`/user/disable `, params);
}

// 获取所有角色
export function queryRoleList(params) {
  return API.get(`/user/role`, { params });
}

// 获取角色详情
export function queryRoleDetail(params) {
  return API.get(`/user/role/${params.id}`);
}

// 新增角色
export function addUserRole(params) {
  return API.post(`/user/role`, params);
}

// 编辑角色
export function editUserRole(params) {
  return API.patch(`/user/role`, params);
}
 ...
 */
// 获取标签列表
export function queryTagsList(params) {
  return API.get(`/user`, { params });
}
// 新增页面标签
...
// 编辑页面标签
export function editPageTags(params) {
  return API.patch(`/user`, params);
}

// 删除页面标签
export function deletePageTags(params) {
 ...
 */
export function getCompListByTag(params) {
  return API.get('/tag/comp-list', { params });
}
