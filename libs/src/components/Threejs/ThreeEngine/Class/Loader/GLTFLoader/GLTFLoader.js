...
let GLTFLoader = (function () {
	...
	GLTFLoader.prototype = Object.assign(Object.create(Loader.prototype), {
		...
		load: function (url, onLoad, onProgress, onError, materials) {
		...
		parse: function (data, path, onLoad, onError, materials) {
			let content;
			let extensions = {};
			let plugins = {};
	...
	*/
	...
	function GLTFMeshStandardSGMaterial(params) {
		...
		//letious chunks that need replacing
	...
	function GLTFParser(json, options, materials) {
		this.json = json || {};
		this.extensions = {};
		this.plugins = {};
	...
	GLTFParser.prototype.loadMaterial = function (materialIndex) {
		...
		if (materials) {
			const existMat = materials[materialDef.name];

			if (existMat) {
				console.log(111);
				return existMat.material;
			}
			else {
				materials[materialDef.name] = { material: undefined };
			}
