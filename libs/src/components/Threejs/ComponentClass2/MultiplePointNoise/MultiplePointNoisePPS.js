...
class MultiplePointNoisePPS extends BasePPS {
            ...
            function initColors() {
                ...
                var smoothStepData = {
                    ...
                    infos: [
                        ...
                        { displayName: "偏置宽度", order: 1, isSlider: true, min: 0.01, max: 0.5 },
    ...
    animateSelf(data, obj, deltaTime, isLog) {
        isLog && console.log("MultiplePointNoise");

        const mainU = data.EffectDic['main'].uniforms;

        mainU.smoothStepT.value += deltaTime * mainU.smoothStep1.value.w;
        ...
        mainU.smoothStep1.value.x = t1 / 120 * 0.5 + 0.2;
        // console.log(mainU.smoothStep1.value.x);
        // obj.gui.refreshGUI();

    }
}
export { MultiplePointNoisePPS };
// class MultiplePointNoisePPS extends BasePPS {
//     initMain(data, obj) {
//         var gui = obj.gui;
//         var mainPass;
