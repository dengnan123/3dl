...
class WaterDropWavePPS extends BasePPS {
    constructor(props) {
        props.data['domID'] = props.data['domID'] || "WebGL_WaterFropWavePPS";
        super(props);
    }
    initMain(data, obj) {
        var gui = obj.gui;
        ...
        function initMainPass() {
            ...
            function initGUI() {
                ...
                var smoothData = {
                    uniform: mainU['smoothSetting'], infos: [
                ...
                var colorTopData = { uniform: mainU['colorTop'], isColor: true, infos: [{ displayName: "顶部颜色", order: -1 }] };
                var colorBottomData = { uniform: mainU['colorBottom'], isColor: true, infos: [{ displayName: "底部颜色", order: -1 }] };
...
export default WaterDropWavePPS;