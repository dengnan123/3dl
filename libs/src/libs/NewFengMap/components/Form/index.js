  ...
  return (
    <Collapse defaultActiveKey={['0']} accordion>
      <Panel header="地图ID">
        ...
        <Form.Item
          label={
            <Tooltip
              ...
              title={
                <span style={{ fontSize: 13 }}>
                  参数: labelLanguage。也可通过其他组件传参(值: zh/en)。
                </span>
              }
            >
              地图标注语言 <Icon type="question-circle" />
            </Tooltip>
          }
          {...formItemLayout}
        >
          {getFieldDecorator(`${activeKey}.labelLanguage`, {
            initialValue: reap(style[activeKey], 'labelLanguage', 'zh'),
          })(
            <Select>
        ...
        {/* <Form.Item label="初始显示模式" {...formItemLayout}>
          {getFieldDecorator(`${activeKey}.defaultViewMode`, {
            initialValue: reap(style[activeKey], 'defaultViewMode', 'top'),
          })(
            <Select>
              <Select.Option value="top">2D</Select.Option>
      ...
      <Panel header="地图基本配置">
        ...
        <Form.Item label={'按钮背景颜色'} {...formItemLayout}>
          {getFieldDecorator(`${activeKey}.btnBackgroundColor`, {
            initialValue: reap(style[activeKey], 'btnBackgroundColor', 'rgba(198,198,198,1)'),
          })(<InputColor />)}
        </Form.Item>
      ...
      <Panel header="地图导航配置">
        ...
        <Form.Item label="设置起点图标的名称" {...formItemLayout}>
          {getFieldDecorator(`${activeKey}.startPoniter`, {
            initialValue: reap(style[activeKey], 'startPoniter', ''),
          })(<Input />)}
        </Form.Item>
      ...
      <Panel disabled={!mapId} header="楼层按钮设置">
        ...
        <Form.Item label="楼层按钮与展开列间距" {...formItemLayout}>
          {getFieldDecorator(`${activeKey}.openMargin`, {
            initialValue: reap(style[activeKey], 'openMargin', 10),
          })(<InputNumber step={1} />)}
        </Form.Item>

        <Form.Item label="楼层是否横向展开" {...formItemLayout}>
          {getFieldDecorator(`${activeKey}.showHorizontal`, {
            initialValue: reap(style[activeKey], 'showHorizontal', false),
            valuePropName: 'checked',
          })(<Switch disabled={true} />)}
        </Form.Item>

        {!showHorizontal && (
          <Form.Item label="楼层纵向展开方向" {...formItemLayout}>
            {getFieldDecorator(`${activeKey}.openDirection`, {
              initialValue: reap(style[activeKey], 'openDirection', 'up'),
            })(
              <Select placeholder="楼层纵向展开方向">
      ...
      <Panel disabled={!mapId} header="2D/3D按钮设置">
        ...
        <Form.Item label="init3D" {...formItemLayout}>
          {getFieldDecorator(`${activeKey}.init3D`, {
            initialValue: reap(style[activeKey], 'init3D', false),
            valuePropName: 'checked',
          })(<Switch />)}
        </Form.Item>
      ...
      <Panel disabled={!mapId} header="地图重置">
        ...
        <Form.Item label="重置后是否回到默认楼层" {...formItemLayout}>
          {getFieldDecorator(`${activeKey}.resetFocusFloor`, {
            initialValue: reap(style[activeKey], 'resetFocusFloor', false),
            valuePropName: 'checked',
          })(<Switch />)}
        </Form.Item>
      ...
      <Panel header="地图数据相关操作">
        ...
        <Form.Item label="加载结束传参到其他组件" {...formItemLayout}>
          {getFieldDecorator(`${activeKey}.needPassParams`, {
            initialValue: reap(style[activeKey], 'needPassParams', false),
            valuePropName: 'checked',
          })(<Switch />)}
        </Form.Item>

        <Form.Item label="点击地图，是否需要发api请求" {...formItemLayout}>
          {getFieldDecorator(`${activeKey}.needFetchApi`, {
            initialValue: reap(style[activeKey], 'needFetchApi', true),
            valuePropName: 'checked',
          })(<Switch />)}
        </Form.Item>
      </Panel>
