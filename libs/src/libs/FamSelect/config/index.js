    ...
    <div style={{ paddingLeft: 10, paddingRight: 10 }} className={styles.container}>
      <Collapse accordion>
        ...
        <Panel header="内容设置" key="内容设置">
          ...
          <Form.Item label="挂载的容器ID" {...formItemLayout}>
            {getFieldDecorator('parentId', {
              initialValue: parentId || null,
            })(<Input />)}
          </Form.Item>
          <Form.Item label="Menu距离容器顶部距离" {...formItemLayout}>
            {getFieldDecorator('menuMarginTop', {
              initialValue: menuMarginTop || 0,
            })(<InputNumber />)}
          </Form.Item>
        </Panel>
      </Collapse>
