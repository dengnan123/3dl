...
import sixtyMinutes from '../../../../assets/sixtyMinutes.png';
import thirtyMinutes from '../../../../assets/thirtyMinutes.png';
import standardBook from '../../../../assets/standardBook.png';
import booking from '../../../../assets/booking.png';
import bookingZh from '../../../../assets/bookingZh.png';
import end from '../../../../assets/end.png';
import endZh from '../../../../assets/endZh.png';
import extend from '../../../../assets/extend.png';
import extendZh from '../../../../assets/extendZh.png';
  ...
  const getTimeRender = () => {
    return (
      <Fragment>
        {arr.map((v, index) => {
          const { duration } = v;
          const imgBg = duration === 30 ? thirtyMinutes : sixtyMinutes;
          return (
            <span
              type="primary"
              onClick={() => {
              ...
              id={`${index}_timer`}
            >
              <img id={`${index}_timer_img`} src={imgBg} alt=""></img>
