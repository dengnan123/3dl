...
const MaterialConfig = props => {
  ...
  const linepadding = reap(style, 'linepadding');
        ...
        <Fragment>
          <Form.Item label="左上圆角" {...formItemLayout}>
            {getFieldDecorator('borderTopLeftRadius', {
              initialValue: reap(style, 'borderTopLeftRadius', 0),
            })(
              <InputSlider
                updateStyle={updateStyle}
                style={style}
                ...
                max={500}
                step={1}
                transMarks={borderRadiusMarks}
                valueName="borderTopLeftRadius"
              />,
            )}
          </Form.Item>
          ...
          <Form.Item label="左下圆角" {...formItemLayout}>
            {getFieldDecorator('borderBottomLeftRadius', {
              initialValue: reap(style, 'borderBottomLeftRadius', 0),
            })(
              <InputSlider
                updateStyle={updateStyle}
                style={style}
                ...
                step={1}
                transMarks={borderRadiusMarks}
                valueName="borderBottomLeftRadius"
              />,
            )}
          </Form.Item>
          ...
          <Form.Item label="右上圆角" {...formItemLayout}>
            {getFieldDecorator('borderTopRightRadius', {
              initialValue: reap(style, 'borderTopRightRadius', 0),
            })(
              <InputSlider
                updateStyle={updateStyle}
                style={style}
                ...
                step={1}
                transMarks={borderRadiusMarks}
                valueName="borderTopRightRadius"
              />,
            )}
          </Form.Item>
          ...
          <Form.Item label="右下圆角" {...formItemLayout}>
            {getFieldDecorator('borderBottomRightRadius', {
              initialValue: reap(style, 'borderBottomRightRadius', 0),
            })(
              <InputSlider
                updateStyle={updateStyle}
                style={style}
                ...
                step={1}
                transMarks={borderRadiusMarks}
                valueName="borderBottomRightRadius"
              />,
            )}
          </Form.Item>
        </Fragment>
